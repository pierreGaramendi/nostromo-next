        ...
        <Card className={cn("w-[320px]", className)} {...props}>
            <CardHeader onClick={navigateToDetail} className="cursor-pointer">
                <div className="flex justify-center">
                    <Image width={200} height={300} className="rounded-lg" src={product.thumbnail} alt="Iamgen del Producto" />
                </div>
            ...
            <CardContent className="grid gap-4">
                <Badge variant="default">
                    ...
                    <Star size={18} strokeWidth={1.5}/>
                    <Star size={18} strokeWidth={1.5}/>
                    <div className="ml-2">{product.rating.avg} ({product.rating.total} reviews)</div>
